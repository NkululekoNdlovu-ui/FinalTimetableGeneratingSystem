...
public class TimeTableDao {
    ...
    // Retrieve TimeTables by lectureId
public ArrayList<TimeTable> retrieveTimeTablesByLectureId(int lectureId) throws SQLException {
    ensureConnection();  // Ensure connection before retrieving by lecture
    ArrayList<TimeTable> timeTables = new ArrayList<>();
    String sql = "SELECT * FROM TimeTable WHERE lectureId = ?";
